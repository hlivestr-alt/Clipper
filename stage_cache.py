...
STAGE_CONFIG_KEYS = {
    ...
    "ffmpeg": [
        ...
        "WHATSAPP_POLICY_REVISION",
        "WHATSAPP_MAX_BYTES",
        "WHATSAPP_TARGET_BYTES",
        "WHATSAPP_AUDIO_BITRATE",
        "WHATSAPP_MAX_FPS",
        "WHATSAPP_GOP_SECONDS",
        "WHATSAPP_LEVEL_720P",
        "WHATSAPP_LEVEL_1080P",
        "WHATSAPP_720P_THRESHOLD_BPS",
        "WHATSAPP_MAX_VIDEO_BITRATE_BPS",
        "WHATSAPP_NVENC_PRESET",
        "WHATSAPP_NVENC_TUNE",
        "WHATSAPP_NVENC_MULTIPASS",
        "WHATSAPP_MAX_ENCODE_ATTEMPTS",
        "WHATSAPP_RETAIN_MASTER",
        "WHATSAPP_MASTER_VIDEO_BITRATE_BPS",
        "WHATSAPP_OUTPUT_COLOR_RANGE",
        "WHATSAPP_OUTPUT_COLOR_SPACE",
        "WHATSAPP_OUTPUT_COLOR_PRIMARIES",
        "WHATSAPP_OUTPUT_COLOR_TRANSFER",
        "WHATSAPP_UNKNOWN_COLOR_POLICY",
        "WHATSAPP_HDR_POLICY",
        "MAX_PARALLEL_CLIPS",
        "RAW_CUT_CODEC",
        "RAW_CUT_PRESET",
