...
ANALYZER_VERSION = "modscan-v3.2"
PROMPT_VERSION = "modscan-prompt-v3"
...
ACTIVE_PRODUCT_CONTEXT_SECONDS = 120.0
COMPOSITION_MAXIMUM_GAP_SECONDS = 8.0
COMPOSITION_MAXIMUM_CHAIN_LENGTH = 3
COMPOSITION_PREFERRED_MINIMUM_SECONDS = 5.0
COMPOSITION_GAP_CONFIDENCE_PENALTY_PER_SECOND = 0.005
CROSS_WINDOW_PRODUCT_CONFLICT_IOU_THRESHOLD = 0.50
